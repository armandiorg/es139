...
import { User, PersonalityType, HobbyCategory, VocationalGoal, SearchRequest, Match, Conversation } from '../types';

interface AppState {
  currentUser: User;
  updateUser: (updates: Partial<User>) => void;
  setPersonalityType: (type: PersonalityType) => void;
  setInterests: (hobbies: HobbyCategory[], goals: VocationalGoal[]) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const setInterests = (hobbies: HobbyCategory[], goals: VocationalGoal[]) => {
    setCurrentUser(prev => ({ ...prev, hobbies, goals }));
  };
